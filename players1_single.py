...
with beam.Pipeline('DirectRunner', options = opts) as p:
    ...
    query_results = p | 'Read from BigQuery' >> beam.io.Read(beam.io.BigQuerySource(query='SELECT * FROM seanlahman_modeled.players1 LIMIT 1000'))
    ...
    # make the BQ table
    qualified_table_name = PROJECT_ID + ':seanlahman_modeled.players1_Beam'
